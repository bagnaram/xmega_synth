...
#define SD_COM_PORT PORTA //this port is where the SD communication takes place


// Set DQ as AVR MISO
#define DO_INIT()					/* Initialize port MMC DO as input */
#define DO_DQ		3 //pin offset
#define DO			(SD_COM_PORT.IN &	(1<<DO_DQ))	/* Test for MMC DO ('H':true, 'L':false) */

// Set DQ as AVR MOSI
#define DI_DQ		6 //pin offset
